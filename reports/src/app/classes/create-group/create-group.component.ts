...
export class CreateGroupComponent implements OnInit {
    ...
    dataStructureMethods: { id: number, text: string, subMethods: { id: number, text: string, image: string, function?: any, input?: { id: string, type: string, text: string }[]}[]}[] = [
      {
        id: 0,
        text: 'Attempt an automatic data sort!',
        subMethods: [{ id: 0, text: '', image: '', function: () => { this.autoGenerateData() } }]
      },{
        id: 1,
        text: 'Data from Powerschool',
        subMethods: [{
          id: 0, text: 'Copy and paste from Powerteacher Pro',
          image: '',
          function: () => { this.verticalDataWithSmartSplit(); }
        }, {
          id: 1, text: 'Powerteacher Pro Export',
          image: '',
        ...
        subMethods: [{ id: 0, text: '', image: '', function: () => { } }]
      }, {
        id: 4,
        text: 'Data from a known data type (CSV, TSV etc)',
        subMethods: [{
          id: 0, text: 'CSV Data Type (Comma,separated,data)',
          image: '',
          function: () => {this.generateUserDataRowByRow('\n', ',');}
        },{
          id: 1, text: 'TSV Data Type (Tab  separated data)',
          image: '',
          function: () => { this.generateUserDataRowByRow('\n', '\\t'); }
        },{
          id: 2, text: 'Other Separated Data Type',
          image: '',
    ...
    generateUserData() {
      if(this.verticalData) {
        if(this.separation === 'ptcp') {
          console.log(`smart split`);
          this.verticalDataWithSmartSplit();
        } else {
    ...
    verticalDataWithSmartSplit(): void {
      // first split normally with vertical data...
      this.verticalColumnsDataGeneration();
      this.smartSplit();
    }
